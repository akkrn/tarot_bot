...
# TODO Сделать дополнительну оплату через ЮКассу
# Переписать методы, доавить отдельно пополнение баланса не только в баллах,
# но и в рублях. Добавить прозрачное описание сумм за каждуб услугу
# Предлагать на выбор либо звезды, либо СБП
